...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .and()
                .addFilter(new JWTAuthenticationFilter(authenticationManager(), securityProps))
                .addFilter(new JWTAuthenticationVerificationFilter(authenticationManager(), securityProps))
